...
STATIC_ROOT = path.join(BASE_DIR, '../sitemedia')
...
SECRET_KEY = 'nq7(@+a$dz6fdf@w4xixxgq&biw_y4xa*a++x=^n#!t_-3*=%-'
...
# TWAP SETTINGS
TWAP_SEARCHLIST = ['#ows', '#occupywallstreet', '#occupywallst', '#occupyws', '#occupywallstr']
